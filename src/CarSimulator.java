...
public class CarSimulator extends Canvas implements Runnable, CarSpeed{
    ...
    volatile private boolean ignition = false;     //engine off 引擎关闭
    ...
    final static int maxSpeed = 120;    //最大速度
    final static double maxThrottle = 10.0; //最大节流阀
    final static int maxBrake = 10; //最大刹车
    final static double airResistance = maxSpeed/maxThrottle;  //inverse air resistance factor 反向空气阻力系数
